                      ...
                      <transition name="slide-fade">
                        <div v-if="textcomp.displayContributeCard" class="u-paddingLeft20 u-paddingRight20">
                          ...
                          <div class="u-sizeFullWidth">
                            <p class="talkButton montserratLight u-floatRight u-inlineBlock" v-on:click="submitWhy(textcomp), textcomp.showUserResponse = 'block'">Share</p>
                          ...
                          <div v-if="(m.agree*100).toFixed(0) != 0 && (m.disagree*100).toFixed(0) != 0 " class="u-inlineBlock u-sizeFullWidth">
                            <div class="col-xs-6 grayBorderRB">
                                <h4 class="agreeTeal">{{(m.agree*100).toFixed(0)}}% agree</h4>
                            ...
                            <div class="col-xs-6 grayBorderLB">
                                <h4 class="disagreeRed">{{(m.disagree*100).toFixed(0)}}% disagree</h4>
