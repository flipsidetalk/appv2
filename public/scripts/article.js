...
function fetchClaims(groupId, textcomp, mapcomp) {
...
function fetchEveryone(textcomp, mapcomp) {
...
function fetchNextClaim(mapcomp, textcomp) {
  mapcomp.showVotePercents = 'none';
  textcomp.displayVoteCard = 'block';
...
function addBorder(groupId, mapcomp) {
...
function postResponse(statement, sentenceId) {
  var data = {
...
function submitVote(input, seenvalue, textcomp, mapcomp) {
...
function postVote(sentenceId, reaction, mapcomp) {
  var data = {
    sentenceId: sentenceId,
    reaction: reaction
  }
...
function fetchCommentsFromCard(textcomp) {
